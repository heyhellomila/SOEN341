			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form action="editProfilePage.php" class="form-horizontal" method="POST">
						...
						<input type="password" class="form-control" id="new_password_confirm" name="newpassword_confirm" placeholder="Confirm your new password here">
						<div class="panel panel-default">
							<div class="panel-body">
								<div align="center">
									
									<div class="cc-selector">
											<input <?php if($_SESSION["userInfo"]["user_img"] == "captain.png") echo "checked"; ?> id="captain" type="radio" name="profile_picture" value="captain.png" />
											<label class="profileimage-cc img_captain" for="captain"></label>
											<input <?php if($_SESSION["userInfo"]["user_img"] == "astronaut.png") echo "checked"; ?> id="astronaut" type="radio" name="profile_picture" value="astronaut.png" />
											<label class="profileimage-cc img_astronaut" for="astronaut"></label>
											<input <?php if($_SESSION["userInfo"]["user_img"] == "concierge.png") echo "checked"; ?> id="concierge" type="radio" name="profile_picture" value="concierge.png" />
											<label class="profileimage-cc img_concierge" for="concierge"></label>
											<input <?php if($_SESSION["userInfo"]["user_img"] == "cooker.png") echo "checked"; ?> id="cooker" type="radio" name="profile_picture" value="cooker.png" />
											<label class="profileimage-cc img_cooker" for="cooker"></label>
											<input <?php if($_SESSION["userInfo"]["user_img"] == "firefighter.png") echo "checked"; ?> id="firefighter" type="radio" name="profile_picture" value="firefighter.png" />
											<label class="profileimage-cc img_firefighter" for="firefighter"></label>
											<input <?php if($_SESSION["userInfo"]["user_img"] == "judge.png") echo "checked"; ?> id="judge" type="radio" name="profile_picture" value="judge.png" />
											<label class="profileimage-cc img_judge" for="judge"></label>
											<input <?php if($_SESSION["userInfo"]["user_img"] == "maid.png") echo "checked"; ?> id="maid" type="radio" name="profile_picture" value="maid.png" />
											<label class="profileimage-cc img_maid" for="maid"></label>
											<input <?php if($_SESSION["userInfo"]["user_img"] == "writer.png") echo "checked"; ?> id="writer" type="radio" name="profile_picture" value="writer.png" />
